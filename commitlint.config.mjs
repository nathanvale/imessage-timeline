export default {
  ...
  ignores: [
    ...
    // Ignore merge commits created by GitHub/Git
    (message) => message.startsWith('Merge '),
    // Ignore release/version commits generated by Changesets
    (message) => message.startsWith('chore(release)'),
    (message) => message.startsWith('chore: release'),
    // Ignore Changesets version PR commits (default message)
    (message) => message.trim().startsWith('Version Packages'),
  ],
}
